...
def generator():
    ...
    # encoder
    input1 = Input(shape=(512,256,3))
    enc_1 = Conv2D(filters=64, kernel_size=(3,3), strides=1, padding='same',input_shape=(512,256,3))(input1)
...
def GAN(generator, discriminator):
    ...
    gen_input = Input(shape=(512,256,3))
